...
!function(a,b){"object"==typeof exports&&"undefined"!=typeof module?module.exports=b():"function"==typeof define&&define.amd?define(b):a.moment=b()}(this,function(){"use strict";function a(){return Sc.apply(null,arguments)}
// This is done to register the method called with moment()
// without creating circular dependencies.
function b(a){Sc=a}function c(a){return"[object Array]"===Object.prototype.toString.call(a)}function d(a){return a instanceof Date||"[object Date]"===Object.prototype.toString.call(a)}function e(a,b){var c,d=[];for(c=0;c<a.length;++c)d.push(b(a[c],c));return d}function f(a,b){return Object.prototype.hasOwnProperty.call(a,b)}function g(a,b){for(var c in b)f(b,c)&&(a[c]=b[c]);return f(b,"toString")&&(a.toString=b.toString),f(b,"valueOf")&&(a.valueOf=b.valueOf),a}function h(a,b,c,d){return za(a,b,c,d,!0).utc()}function i(){
// We need to deep clone this object.
return{empty:!1,unusedTokens:[],unusedInput:[],overflow:-2,charsLeftOver:0,nullInput:!1,invalidMonth:null,invalidFormat:!1,userInvalidated:!1,iso:!1}}function j(a){return null==a._pf&&(a._pf=i()),a._pf}function k(a){if(null==a._isValid){var b=j(a);a._isValid=!(isNaN(a._d.getTime())||!(b.overflow<0)||b.empty||b.invalidMonth||b.invalidWeekday||b.nullInput||b.invalidFormat||b.userInvalidated),a._strict&&(a._isValid=a._isValid&&0===b.charsLeftOver&&0===b.unusedTokens.length&&void 0===b.bigHour)}return a._isValid}function l(a){var b=h(NaN);return null!=a?g(j(b),a):j(b).userInvalidated=!0,b}function m(a){return void 0===a}function n(a,b){var c,d,e;if(m(b._isAMomentObject)||(a._isAMomentObject=b._isAMomentObject),m(b._i)||(a._i=b._i),m(b._f)||(a._f=b._f),m(b._l)||(a._l=b._l),m(b._strict)||(a._strict=b._strict),m(b._tzm)||(a._tzm=b._tzm),m(b._isUTC)||(a._isUTC=b._isUTC),m(b._offset)||(a._offset=b._offset),m(b._pf)||(a._pf=j(b)),m(b._locale)||(a._locale=b._locale),Uc.length>0)for(c in Uc)d=Uc[c],e=b[d],m(e)||(a[d]=e);return a}
// Moment prototype object
function o(b){n(this,b),this._d=new Date(null!=b._d?b._d.getTime():NaN),Vc===!1&&(Vc=!0,a.updateOffset(this),Vc=!1)}function p(a){return a instanceof o||null!=a&&null!=a._isAMomentObject}function q(a){return 0>a?Math.ceil(a):Math.floor(a)}function r(a){var b=+a,c=0;return 0!==b&&isFinite(b)&&(c=q(b)),c}
...
if(!Wc[a]&&!m(module)&&module&&module.exports)try{b=Tc._abbr,require("./locale/"+a),
// because defineLocale currently also sets the global locale, we
// want to undo that for lazy loaded locales
x(b)}catch(c){}return Wc[a]}
// This function will load locale and then set the global locale.  If
// no arguments are passed in, it will simply return the current global
// locale key.
function x(a,b){var c;
// moment.duration._locale = moment._locale = data;
return a&&(c=m(b)?z(a):y(a,b),c&&(Tc=c)),Tc._abbr}function y(a,b){
// backwards compat for now: also set the locale
// useful for testing
return null!==b?(b.abbr=a,Wc[a]=Wc[a]||new t,Wc[a].set(b),x(a),Wc[a]):(delete Wc[a],null)}
// returns locale data
function z(a){var b;if(a&&a._locale&&a._locale._abbr&&(a=a._locale._abbr),!a)return Tc;if(!c(a)){if(b=w(a))return b;a=[a]}return v(a)}function A(a,b){var c=a.toLowerCase();Xc[c]=Xc[c+"s"]=Xc[b]=a}function B(a){return"string"==typeof a?Xc[a]||Xc[a.toLowerCase()]:void 0}function C(a){var b,c,d={};for(c in a)f(a,c)&&(b=B(c),b&&(d[b]=a[c]));return d}function D(a){return a instanceof Function||"[object Function]"===Object.prototype.toString.call(a)}function E(b,c){return function(d){return null!=d?(G(this,b,d),a.updateOffset(this,c),this):F(this,b)}}function F(a,b){return a.isValid()?a._d["get"+(a._isUTC?"UTC":"")+b]():NaN}function G(a,b,c){a.isValid()&&a._d["set"+(a._isUTC?"UTC":"")+b](c)}
// MOMENTS
...
function J(a,b,c,d){var e=d;"string"==typeof d&&(e=function(){return this[d]()}),a&&(_c[a]=e),b&&(_c[b[0]]=function(){return I(e.apply(this,arguments),b[1],b[2])}),c&&(_c[c]=function(){return this.localeData().ordinal(e.apply(this,arguments),a)})}function K(a){return a.match(/\[[\s\S]/)?a.replace(/^\[|\]$/g,""):a.replace(/\\/g,"")}function L(a){var b,c,d=a.match(Yc);for(b=0,c=d.length;c>b;b++)_c[d[b]]?d[b]=_c[d[b]]:d[b]=K(d[b]);return function(e){var f="";for(b=0;c>b;b++)f+=d[b]instanceof Function?d[b].call(e,a):d[b];return f}}
// format date using native date object
function M(a,b){return a.isValid()?(b=N(b,a.localeData()),$c[b]=$c[b]||L(b),$c[b](a)):a.localeData().invalidDate()}function N(a,b){function c(a){return b.longDateFormat(a)||a}var d=5;for(Zc.lastIndex=0;d>=0&&Zc.test(a);)a=a.replace(Zc,c),Zc.lastIndex=0,d-=1;return a}function O(a,b,c){rd[a]=D(b)?b:function(a){return a&&c?c:b}}function P(a,b){return f(rd,a)?rd[a](b._strict,b._locale):new RegExp(Q(a))}
// Code from http://stackoverflow.com/questions/3561493/is-there-a-regexp-escape-function-in-javascript
function Q(a){return a.replace("\\","").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g,function(a,b,c,d,e){return b||c||d||e}).replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")}function R(a,b){var c,d=b;for("string"==typeof a&&(a=[a]),"number"==typeof b&&(d=function(a,c){c[b]=r(a)}),c=0;c<a.length;c++)sd[a[c]]=d}function S(a,b){R(a,function(a,c,d,e){d._w=d._w||{},b(a,d._w,d,e)})}function T(a,b,c){null!=b&&f(sd,a)&&sd[a](b,c._a,c,a)}function U(a,b){return new Date(Date.UTC(a,b+1,0)).getUTCDate()}function V(a,b){return c(this._months)?this._months[a.month()]:this._months[Cd.test(b)?"format":"standalone"][a.month()]}function W(a,b){return c(this._monthsShort)?this._monthsShort[a.month()]:this._monthsShort[Cd.test(b)?"format":"standalone"][a.month()]}function X(a,b,c){var d,e,f;for(this._monthsParse||(this._monthsParse=[],this._longMonthsParse=[],this._shortMonthsParse=[]),d=0;12>d;d++){
// test the regex
if(e=h([2e3,d]),c&&!this._longMonthsParse[d]&&(this._longMonthsParse[d]=new RegExp("^"+this.months(e,"").replace(".","")+"$","i"),this._shortMonthsParse[d]=new RegExp("^"+this.monthsShort(e,"").replace(".","")+"$","i")),c||this._monthsParse[d]||(f="^"+this.months(e,"")+"|^"+this.monthsShort(e,""),this._monthsParse[d]=new RegExp(f.replace(".",""),"i")),c&&"MMMM"===b&&this._longMonthsParse[d].test(a))return d;if(c&&"MMM"===b&&this._shortMonthsParse[d].test(a))return d;if(!c&&this._monthsParse[d].test(a))return d}}
// MOMENTS
function Y(a,b){var c;
// TODO: Move this out of here!
return a.isValid()?"string"==typeof b&&(b=a.localeData().monthsParse(b),"number"!=typeof b)?a:(c=Math.min(a.date(),U(a.year(),b)),a._d["set"+(a._isUTC?"UTC":"")+"Month"](b,c),a):a}function Z(b){return null!=b?(Y(this,b),a.updateOffset(this,!0),this):F(this,"Month")}function $(){return U(this.year(),this.month())}function _(a){var b,c=a._a;return c&&-2===j(a).overflow&&(b=c[ud]<0||c[ud]>11?ud:c[vd]<1||c[vd]>U(c[td],c[ud])?vd:c[wd]<0||c[wd]>24||24===c[wd]&&(0!==c[xd]||0!==c[yd]||0!==c[zd])?wd:c[xd]<0||c[xd]>59?xd:c[yd]<0||c[yd]>59?yd:c[zd]<0||c[zd]>999?zd:-1,j(a)._overflowDayOfYear&&(td>b||b>vd)&&(b=vd),j(a)._overflowWeeks&&-1===b&&(b=Ad),j(a)._overflowWeekday&&-1===b&&(b=Bd),j(a).overflow=b),a}function aa(b){a.suppressDeprecationWarnings===!1&&!m(console)&&console.warn&&console.warn("Deprecation warning: "+b)}function ba(a,b){var c=!0;return g(function(){return c&&(aa(a+"\nArguments: "+Array.prototype.slice.call(arguments).join(", ")+"\n"+(new Error).stack),c=!1),b.apply(this,arguments)},b)}function ca(a,b){Fd[a]||(aa(b),Fd[a]=!0)}
// date from iso format
function da(a){var b,c,d,e,f,g,h=a._i,i=Gd.exec(h)||Hd.exec(h);if(i){for(j(a).iso=!0,b=0,c=Jd.length;c>b;b++)if(Jd[b][1].exec(i[1])){e=Jd[b][0],d=Jd[b][2]!==!1;break}if(null==e)return void(a._isValid=!1);if(null!=i[3]){for(b=0,c=Kd.length;c>b;b++)if(Kd[b][1].exec(i[3])){
// match[2] should be 'T' or space
f=(i[2]||" ")+Kd[b][0];break}if(null==f)return void(a._isValid=!1)}if(!d&&null!=f)return void(a._isValid=!1);if(null!=i[4]){if(!Id.exec(i[4]))return void(a._isValid=!1);g="Z"}a._f=e+(f||"")+(g||""),sa(a)}else a._isValid=!1}
// date from iso format or fallback
function ea(b){var c=Ld.exec(b._i);return null!==c?void(b._d=new Date(+c[1])):(da(b),void(b._isValid===!1&&(delete b._isValid,a.createFromInputFallback(b))))}function fa(a,b,c,d,e,f,g){
...
for(d=pa(a),a._w&&null==a._a[vd]&&null==a._a[ud]&&ra(a),a._dayOfYear&&(e=oa(a._a[td],d[td]),a._dayOfYear>ha(e)&&(j(a)._overflowDayOfYear=!0),c=ga(e,0,a._dayOfYear),a._a[ud]=c.getUTCMonth(),a._a[vd]=c.getUTCDate()),b=0;3>b&&null==a._a[b];++b)a._a[b]=f[b]=d[b];
// Zero out whatever was not defaulted, including time
for(;7>b;b++)a._a[b]=f[b]=null==a._a[b]?2===b?1:0:a._a[b];
// Check for 24:00:00.000
24===a._a[wd]&&0===a._a[xd]&&0===a._a[yd]&&0===a._a[zd]&&(a._nextDay=!0,a._a[wd]=0),a._d=(a._useUTC?ga:fa).apply(null,f),
// Apply timezone offset from input. The actual utcOffset can be changed
// with parseZone.
null!=a._tzm&&a._d.setUTCMinutes(a._d.getUTCMinutes()-a._tzm),a._nextDay&&(a._a[wd]=24)}}function ra(a){var b,c,d,e,f,g,h,i;b=a._w,null!=b.GG||null!=b.W||null!=b.E?(f=1,g=4,c=oa(b.GG,a._a[td],ma(Aa(),1,4).year),d=oa(b.W,1),e=oa(b.E,1),(1>e||e>7)&&(i=!0)):(f=a._locale._week.dow,g=a._locale._week.doy,c=oa(b.gg,a._a[td],ma(Aa(),f,g).year),d=oa(b.w,1),null!=b.d?(e=b.d,(0>e||e>6)&&(i=!0)):null!=b.e?(e=b.e+f,(b.e<0||b.e>6)&&(i=!0)):e=f),1>d||d>na(c,f,g)?j(a)._overflowWeeks=!0:null!=i?j(a)._overflowWeekday=!0:(h=la(c,d,e,f,g),a._a[td]=h.year,a._dayOfYear=h.dayOfYear)}
// date from string and format string
function sa(b){
// TODO: Move this to another part of the creation flow to prevent circular deps
if(b._f===a.ISO_8601)return void da(b);b._a=[],j(b).empty=!0;
// This array is used to make a Date, either with `new Date` or `Date.UTC`
var c,d,e,f,g,h=""+b._i,i=h.length,k=0;for(e=N(b._f,b._locale).match(Yc)||[],c=0;c<e.length;c++)f=e[c],d=(h.match(P(f,b))||[])[0],d&&(g=h.substr(0,h.indexOf(d)),g.length>0&&j(b).unusedInput.push(g),h=h.slice(h.indexOf(d)+d.length),k+=d.length),_c[f]?(d?j(b).empty=!1:j(b).unusedTokens.push(f),T(f,d,b)):b._strict&&!d&&j(b).unusedTokens.push(f);
// add remaining unparsed input length to the string
j(b).charsLeftOver=i-k,h.length>0&&j(b).unusedInput.push(h),
// clear _12h flag if hour is <= 12
j(b).bigHour===!0&&b._a[wd]<=12&&b._a[wd]>0&&(j(b).bigHour=void 0),
// handle meridiem
b._a[wd]=ta(b._locale,b._a[wd],b._meridiem),qa(b),_(b)}function ta(a,b,c){var d;
// Fallback
...
// FORMATTING
function Ga(a,b){J(a,0,0,function(){var a=this.utcOffset(),c="+";return 0>a&&(a=-a,c="-"),c+I(~~(a/60),2)+b+I(~~a%60,2)})}function Ha(a,b){var c=(b||"").match(a)||[],d=c[c.length-1]||[],e=(d+"").match(Qd)||["-",0,0],f=+(60*e[1])+r(e[2]);return"+"===e[0]?f:-f}
...
function Ka(b,c){var d,e=this._offset||0;return this.isValid()?null!=b?("string"==typeof b?b=Ha(od,b):Math.abs(b)<16&&(b=60*b),!this._isUTC&&c&&(d=Ja(this)),this._offset=b,this._isUTC=!0,null!=d&&this.add(d,"m"),e!==b&&(!c||this._changeInProgress?$a(this,Va(b-e,"m"),1,!1):this._changeInProgress||(this._changeInProgress=!0,a.updateOffset(this,!0),this._changeInProgress=null)),this):this._isUTC?e:Ja(this):null!=b?this:NaN}function La(a,b){return null!=a?("string"!=typeof a&&(a=-a),this.utcOffset(a,b),this):-this.utcOffset()}function Ma(a){return this.utcOffset(0,a)}function Na(a){return this._isUTC&&(this.utcOffset(0,a),this._isUTC=!1,a&&this.subtract(Ja(this),"m")),this}function Oa(){return this._tzm?this.utcOffset(this._tzm):"string"==typeof this._i&&this.utcOffset(Ha(nd,this._i)),this}function Pa(a){return this.isValid()?(a=a?Aa(a).utcOffset():0,(this.utcOffset()-a)%60===0):!1}function Qa(){return this.utcOffset()>this.clone().month(0).utcOffset()||this.utcOffset()>this.clone().month(5).utcOffset()}function Ra(){if(!m(this._isDSTShifted))return this._isDSTShifted;var a={};if(n(a,this),a=xa(a),a._a){var b=a._isUTC?h(a._a):Aa(a._a);this._isDSTShifted=this.isValid()&&s(a._a,b.toArray())>0}else this._isDSTShifted=!1;return this._isDSTShifted}function Sa(){return this.isValid()?!this._isUTC:!1}function Ta(){return this.isValid()?this._isUTC:!1}function Ua(){return this.isValid()?this._isUTC&&0===this._offset:!1}function Va(a,b){var c,d,e,g=a,
// matching against regexp is expensive, do it on demand
h=null;// checks for null or undefined
return Fa(a)?g={ms:a._milliseconds,d:a._days,M:a._months}:"number"==typeof a?(g={},b?g[b]=a:g.milliseconds=a):(h=Rd.exec(a))?(c="-"===h[1]?-1:1,g={y:0,d:r(h[vd])*c,h:r(h[wd])*c,m:r(h[xd])*c,s:r(h[yd])*c,ms:r(h[zd])*c}):(h=Sd.exec(a))?(c="-"===h[1]?-1:1,g={y:Wa(h[2],c),M:Wa(h[3],c),d:Wa(h[4],c),h:Wa(h[5],c),m:Wa(h[6],c),s:Wa(h[7],c),w:Wa(h[8],c)}):null==g?g={}:"object"==typeof g&&("from"in g||"to"in g)&&(e=Ya(Aa(g.from),Aa(g.to)),g={},g.ms=e.milliseconds,g.M=e.months),d=new Ea(g),Fa(a)&&f(a,"_locale")&&(d._locale=a._locale),d}function Wa(a,b){
...
return"p"===(a+"").toLowerCase().charAt(0)}function cc(a,b,c){return a>11?c?"pm":"PM":c?"am":"AM"}function dc(a,b){b[zd]=r(1e3*("0."+a))}
// MOMENTS
...
function Lc(a,b,c,d,e){return e.relativeTime(b||1,!!c,a,d)}function Mc(a,b,c){var d=Va(a).abs(),e=Ee(d.as("s")),f=Ee(d.as("m")),g=Ee(d.as("h")),h=Ee(d.as("d")),i=Ee(d.as("M")),j=Ee(d.as("y")),k=e<Fe.s&&["s",e]||1>=f&&["m"]||f<Fe.m&&["mm",f]||1>=g&&["h"]||g<Fe.h&&["hh",g]||1>=h&&["d"]||h<Fe.d&&["dd",h]||1>=i&&["M"]||i<Fe.M&&["MM",i]||1>=j&&["y"]||["yy",j];return k[2]=b,k[3]=+a>0,k[4]=c,Lc.apply(null,k)}
// This function allows you to set a threshold for relative time strings
function Nc(a,b){return void 0===Fe[a]?!1:void 0===b?Fe[a]:(Fe[a]=b,!0)}function Oc(a){var b=this.localeData(),c=Mc(this,!a,b);return a&&(c=b.pastFuture(+this,c)),b.postformat(c)}function Pc(){
...
var a,b,c,d=Ge(this._milliseconds)/1e3,e=Ge(this._days),f=Ge(this._months);a=q(d/60),b=q(a/60),d%=60,a%=60,c=q(f/12),f%=12;
...
function Qc(a,b){var c=a.split("_");return b%10===1&&b%100!==11?c[0]:b%10>=2&&4>=b%10&&(10>b%100||b%100>=20)?c[1]:c[2]}function Rc(a,b,c){var d={mm:b?"минута_минуты_минут":"минуту_минуты_минут",hh:"час_часа_часов",dd:"день_дня_дней",MM:"месяц_месяца_месяцев",yy:"год_года_лет"};return"m"===c?b?"минута":"минуту":a+" "+Qc(d[c],+a)}var Sc,Tc,Uc=a.momentProperties=[],Vc=!1,Wc={},Xc={},Yc=/(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g,Zc=/(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g,$c={},_c={},ad=/\d/,bd=/\d\d/,cd=/\d{3}/,dd=/\d{4}/,ed=/[+-]?\d{6}/,fd=/\d\d?/,gd=/\d\d\d\d?/,hd=/\d\d\d\d\d\d?/,id=/\d{1,3}/,jd=/\d{1,4}/,kd=/[+-]?\d{1,6}/,ld=/\d+/,md=/[+-]?\d+/,nd=/Z|[+-]\d\d:?\d\d/gi,od=/Z|[+-]\d\d(?::?\d\d)?/gi,pd=/[+-]?\d+(\.\d{1,3})?/,qd=/[0-9]*(a[mn]\s?)?['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF\-]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i,rd={},sd={},td=0,ud=1,vd=2,wd=3,xd=4,yd=5,zd=6,Ad=7,Bd=8;
// FORMATTING
...
A("month","M"),
// PARSING
O("M",fd),O("MM",fd,bd),O("MMM",qd),O("MMMM",qd),R(["M","MM"],function(a,b){b[ud]=r(a)-1}),R(["MMM","MMMM"],function(a,b,c,d){var e=c._locale.monthsParse(a,d,c._strict);
// if we didn't find a month name, mark the date as invalid.
null!=e?b[ud]=e:j(c).invalidMonth=a});
// LOCALES
var Cd=/D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/,Dd="January_February_March_April_May_June_July_August_September_October_November_December".split("_"),Ed="Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sept_Oct_Nov_Dec".split("_"),Fd={};a.suppressDeprecationWarnings=!1;
// iso 8601 regex
// 0000-00-00 0000-W00 or 0000-W00-0 + T + 00 or 00:00 or 00:00:00 or 00:00:00.000 + +00:00 or +0000 or +00)
var Gd=/^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?/,Hd=/^\s*((?:[+-]\d{6}|\d{4})(?:\d\d\d\d|W\d\d\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?:\d\d(?:\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?/,Id=/Z|[+-]\d\d(?::?\d\d)?/,Jd=[["YYYYYY-MM-DD",/[+-]\d{6}-\d\d-\d\d/],["YYYY-MM-DD",/\d{4}-\d\d-\d\d/],["GGGG-[W]WW-E",/\d{4}-W\d\d-\d/],["GGGG-[W]WW",/\d{4}-W\d\d/,!1],["YYYY-DDD",/\d{4}-\d{3}/],["YYYY-MM",/\d{4}-\d\d/,!1],["YYYYYYMMDD",/[+-]\d{10}/],["YYYYMMDD",/\d{8}/],
// YYYYMM is NOT allowed by the standard
["GGGG[W]WWE",/\d{4}W\d{3}/],["GGGG[W]WW",/\d{4}W\d{2}/,!1],["YYYYDDD",/\d{7}/]],Kd=[["HH:mm:ss.SSSS",/\d\d:\d\d:\d\d\.\d+/],["HH:mm:ss,SSSS",/\d\d:\d\d:\d\d,\d+/],["HH:mm:ss",/\d\d:\d\d:\d\d/],["HH:mm",/\d\d:\d\d/],["HHmmss.SSSS",/\d\d\d\d\d\d\.\d+/],["HHmmss,SSSS",/\d\d\d\d\d\d,\d+/],["HHmmss",/\d\d\d\d\d\d/],["HHmm",/\d\d\d\d/],["HH",/\d\d/]],Ld=/^\/?Date\((\-?\d+)/i;a.createFromInputFallback=ba("moment construction falls back to js Date. This is discouraged and will be removed in upcoming major release. Please refer to https://github.com/moment/moment/issues/1407 for more info.",function(a){a._d=new Date(a._i+(a._useUTC?" UTC":""))}),
// FORMATTING
J(0,["YY",2],0,function(){return this.year()%100}),J(0,["YYYY",4],0,"year"),J(0,["YYYYY",5],0,"year"),J(0,["YYYYYY",6,!0],0,"year"),
// ALIASES
A("year","y"),
// PARSING
O("Y",md),O("YY",fd,bd),O("YYYY",jd,dd),O("YYYYY",kd,ed),O("YYYYYY",kd,ed),R(["YYYYY","YYYYYY"],td),R("YYYY",function(b,c){c[td]=2===b.length?a.parseTwoDigitYear(b):r(b)}),R("YY",function(b,c){c[td]=a.parseTwoDigitYear(b)}),
// HOOKS
a.parseTwoDigitYear=function(a){return r(a)+(r(a)>68?1900:2e3)};
// MOMENTS
var Md=E("FullYear",!1);
// constant that refers to the ISO standard
a.ISO_8601=function(){};var Nd=ba("moment().min is deprecated, use moment.min instead. https://github.com/moment/moment/issues/1548",function(){var a=Aa.apply(null,arguments);return this.isValid()&&a.isValid()?this>a?this:a:l()}),Od=ba("moment().max is deprecated, use moment.max instead. https://github.com/moment/moment/issues/1548",function(){var a=Aa.apply(null,arguments);return this.isValid()&&a.isValid()?a>this?this:a:l()}),Pd=Date.now||function(){return+new Date};Ga("Z",":"),Ga("ZZ",""),
// PARSING
O("Z",od),O("ZZ",od),R(["Z","ZZ"],function(a,b,c){c._useUTC=!0,c._tzm=Ha(od,a)});
// HELPERS
// timezone chunker
// '+10:00' > ['10',  '00']
// '-1530'  > ['-15', '30']
...
var Rd=/(\-)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?)?/,Sd=/^(-)?P(?:(?:([0-9,.]*)Y)?(?:([0-9,.]*)M)?(?:([0-9,.]*)D)?(?:T(?:([0-9,.]*)H)?(?:([0-9,.]*)M)?(?:([0-9,.]*)S)?)?|([0-9,.]*)W)$/;Va.fn=Ea.prototype;var Td=Za(1,"add"),Ud=Za(-1,"subtract");a.defaultFormat="YYYY-MM-DDTHH:mm:ssZ";var Vd=ba("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.",function(a){return void 0===a?this.localeData():this.locale(a)});
// FORMATTING
...
// PARSING
O("G",md),O("g",md),O("GG",fd,bd),O("gg",fd,bd),O("GGGG",jd,dd),O("gggg",jd,dd),O("GGGGG",kd,ed),O("ggggg",kd,ed),S(["gggg","ggggg","GGGG","GGGGG"],function(a,b,c,d){b[d.substr(0,2)]=r(a)}),S(["gg","GG"],function(b,c,d,e){c[e]=a.parseTwoDigitYear(b)}),
// FORMATTING
J("Q",0,"Qo","quarter"),
// ALIASES
A("quarter","Q"),
// PARSING
O("Q",ad),R("Q",function(a,b){b[ud]=3*(r(a)-1)}),
// FORMATTING
J("w",["ww",2],"wo","week"),J("W",["WW",2],"Wo","isoWeek"),
// ALIASES
A("week","w"),A("isoWeek","W"),
// PARSING
O("w",fd),O("ww",fd,bd),O("W",fd),O("WW",fd,bd),S(["w","ww","W","WW"],function(a,b,c,d){b[d.substr(0,1)]=r(a)});var Wd={dow:0,// Sunday is the first day of the week.
doy:6};
// FORMATTING
J("D",["DD",2],"Do","date"),
// ALIASES
A("date","D"),
// PARSING
O("D",fd),O("DD",fd,bd),O("Do",function(a,b){return a?b._ordinalParse:b._ordinalParseLenient}),R(["D","DD"],vd),R("Do",function(a,b){b[vd]=r(a.match(fd)[0],10)});
// MOMENTS
var Xd=E("Date",!0);
// FORMATTING
...
// PARSING
O("d",fd),O("e",fd),O("E",fd),O("dd",qd),O("ddd",qd),O("dddd",qd),S(["dd","ddd","dddd"],function(a,b,c,d){var e=c._locale.weekdaysParse(a,d,c._strict);
// if we didn't get a weekday name, mark the date as invalid
null!=e?b.d=e:j(c).invalidWeekday=a}),S(["d","e","E"],function(a,b,c,d){b[d]=r(a)});
// LOCALES
var Yd="Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),Zd="Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"),$d="Su_Mo_Tu_We_Th_Fr_Sa".split("_");
// FORMATTING
J("DDD",["DDDD",3],"DDDo","dayOfYear"),
// ALIASES
A("dayOfYear","DDD"),
// PARSING
O("DDD",id),O("DDDD",cd),R(["DDD","DDDD"],function(a,b,c){c._dayOfYear=r(a)}),J("H",["HH",2],0,"hour"),J("h",["hh",2],0,$b),J("hmm",0,0,function(){return""+$b.apply(this)+I(this.minutes(),2)}),J("hmmss",0,0,function(){return""+$b.apply(this)+I(this.minutes(),2)+I(this.seconds(),2)}),J("Hmm",0,0,function(){return""+this.hours()+I(this.minutes(),2)}),J("Hmmss",0,0,function(){return""+this.hours()+I(this.minutes(),2)+I(this.seconds(),2)}),_b("a",!0),_b("A",!1),
// ALIASES
A("hour","h"),O("a",ac),O("A",ac),O("H",fd),O("h",fd),O("HH",fd,bd),O("hh",fd,bd),O("hmm",gd),O("hmmss",hd),O("Hmm",gd),O("Hmmss",hd),R(["H","HH"],wd),R(["a","A"],function(a,b,c){c._isPm=c._locale.isPM(a),c._meridiem=a}),R(["h","hh"],function(a,b,c){b[wd]=r(a),j(c).bigHour=!0}),R("hmm",function(a,b,c){var d=a.length-2;b[wd]=r(a.substr(0,d)),b[xd]=r(a.substr(d)),j(c).bigHour=!0}),R("hmmss",function(a,b,c){var d=a.length-4,e=a.length-2;b[wd]=r(a.substr(0,d)),b[xd]=r(a.substr(d,2)),b[yd]=r(a.substr(e)),j(c).bigHour=!0}),R("Hmm",function(a,b,c){var d=a.length-2;b[wd]=r(a.substr(0,d)),b[xd]=r(a.substr(d))}),R("Hmmss",function(a,b,c){var d=a.length-4,e=a.length-2;b[wd]=r(a.substr(0,d)),b[xd]=r(a.substr(d,2)),b[yd]=r(a.substr(e))});var _d=/[ap]\.?m?\.?/i,ae=E("Hours",!0);
// FORMATTING
J("m",["mm",2],0,"minute"),
// ALIASES
A("minute","m"),
// PARSING
O("m",fd),O("mm",fd,bd),R(["m","mm"],xd);
// MOMENTS
var be=E("Minutes",!1);
// FORMATTING
J("s",["ss",2],0,"second"),
...
A("millisecond","ms"),
// PARSING
O("S",id,ad),O("SS",id,bd),O("SSS",id,cd);var de;for(de="SSSS";de.length<=9;de+="S")O(de,ld);for(de="S";de.length<=9;de+="S")R(de,dc);
// MOMENTS
var ee=E("Milliseconds",!1);
// FORMATTING
J("z",0,0,"zoneAbbr"),J("zz",0,0,"zoneName");var fe=o.prototype;fe.add=Td,fe.calendar=_a,fe.clone=ab,fe.diff=hb,fe.endOf=tb,fe.format=lb,fe.from=mb,fe.fromNow=nb,fe.to=ob,fe.toNow=pb,fe.get=H,fe.invalidAt=Cb,fe.isAfter=bb,fe.isBefore=cb,fe.isBetween=db,fe.isSame=eb,fe.isSameOrAfter=fb,fe.isSameOrBefore=gb,fe.isValid=Ab,fe.lang=Vd,fe.locale=qb,fe.localeData=rb,fe.max=Od,fe.min=Nd,fe.now=Pd,fe.parsingFlags=Bb,fe.set=H,fe.startOf=sb,fe.subtract=Ud,fe.toArray=xb,fe.toObject=yb,fe.toDate=wb,fe.toISOString=kb,fe.toJSON=zb,fe.toString=jb,fe.unix=vb,fe.valueOf=ub,fe.creationData=Db,
// Year
fe.year=Md,fe.isLeapYear=ja,
// Week Year
fe.weekYear=Fb,fe.isoWeekYear=Gb,
// Quarter
fe.quarter=fe.quarters=Lb,
// Month
fe.month=Z,fe.daysInMonth=$,
// Week
fe.week=fe.weeks=Pb,fe.isoWeek=fe.isoWeeks=Qb,fe.weeksInYear=Ib,fe.isoWeeksInYear=Hb,
// Day
fe.date=Xd,fe.day=fe.days=Wb,fe.weekday=Xb,fe.isoWeekday=Yb,fe.dayOfYear=Zb,
// Hour
fe.hour=fe.hours=ae,
// Minute
...
// Offset
fe.utcOffset=Ka,fe.utc=Ma,fe.local=Na,fe.parseZone=Oa,fe.hasAlignedHourOffset=Pa,fe.isDST=Qa,fe.isDSTShifted=Ra,fe.isLocal=Sa,fe.isUtcOffset=Ta,fe.isUtc=Ua,fe.isUTC=Ua,
// Timezone
fe.zoneAbbr=ec,fe.zoneName=fc,
// Deprecations
fe.dates=ba("dates accessor is deprecated. Use date instead.",Xd),fe.months=ba("months accessor is deprecated. Use month instead",Z),fe.years=ba("years accessor is deprecated. Use year instead",Md),fe.zone=ba("moment().zone is deprecated, use moment().utcOffset instead. https://github.com/moment/moment/issues/1779",La);var ge=fe,he={sameDay:"[Today at] LT",nextDay:"[Tomorrow at] LT",nextWeek:"dddd [at] LT",lastDay:"[Yesterday at] LT",lastWeek:"[Last] dddd [at] LT",sameElse:"L"},ie={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},je="Invalid date",ke="%d",le=/\d{1,2}/,me={future:"in %s",past:"%s ago",s:"a few seconds",m:"a minute",mm:"%d minutes",h:"an hour",hh:"%d hours",d:"a day",dd:"%d days",M:"a month",MM:"%d months",y:"a year",yy:"%d years"},ne=t.prototype;ne._calendar=he,ne.calendar=ic,ne._longDateFormat=ie,ne.longDateFormat=jc,ne._invalidDate=je,ne.invalidDate=kc,ne._ordinal=ke,ne.ordinal=lc,ne._ordinalParse=le,ne.preparse=mc,ne.postformat=mc,ne._relativeTime=me,ne.relativeTime=nc,ne.pastFuture=oc,ne.set=pc,
// Month
ne.months=V,ne._months=Dd,ne.monthsShort=W,ne._monthsShort=Ed,ne.monthsParse=X,
// Week
ne.week=Mb,ne._week=Wd,ne.firstDayOfYear=Ob,ne.firstDayOfWeek=Nb,
// Day of Week
ne.weekdays=Sb,ne._weekdays=Yd,ne.weekdaysMin=Ub,ne._weekdaysMin=$d,ne.weekdaysShort=Tb,ne._weekdaysShort=Zd,ne.weekdaysParse=Vb,
// Hours
ne.isPM=bc,ne._meridiemParse=_d,ne.meridiem=cc,x("en",{monthsParse:[/^jan/i,/^feb/i,/^mar/i,/^apr/i,/^may/i,/^jun/i,/^jul/i,/^aug/i,/^sep/i,/^oct/i,/^nov/i,/^dec/i],longMonthsParse:[/^january$/i,/^february$/i,/^march$/i,/^april$/i,/^may$/i,/^june$/i,/^july$/i,/^august$/i,/^september$/i,/^october$/i,/^november$/i,/^december$/i],shortMonthsParse:[/^jan$/i,/^feb$/i,/^mar$/i,/^apr$/i,/^may$/i,/^jun$/i,/^jul$/i,/^aug/i,/^sept?$/i,/^oct$/i,/^nov$/i,/^dec$/i],ordinalParse:/\d{1,2}(th|st|nd|rd)/,ordinal:function(a){var b=a%10,c=1===r(a%100/10)?"th":1===b?"st":2===b?"nd":3===b?"rd":"th";return a+c}}),
// Side effect imports
a.lang=ba("moment.lang is deprecated. Use moment.locale instead.",x),a.langData=ba("moment.langData is deprecated. Use moment.localeData instead.",z);var oe=Math.abs,pe=Hc("ms"),qe=Hc("s"),re=Hc("m"),se=Hc("h"),te=Hc("d"),ue=Hc("w"),ve=Hc("M"),we=Hc("y"),xe=Jc("milliseconds"),ye=Jc("seconds"),ze=Jc("minutes"),Ae=Jc("hours"),Be=Jc("days"),Ce=Jc("months"),De=Jc("years"),Ee=Math.round,Fe={s:45,// seconds to minute
m:45,// minutes to hour
h:22,// hours to day
d:26,// days to month
M:11},Ge=Math.abs,He=Ea.prototype;He.abs=xc,He.add=zc,He.subtract=Ac,He.as=Fc,He.asMilliseconds=pe,He.asSeconds=qe,He.asMinutes=re,He.asHours=se,He.asDays=te,He.asWeeks=ue,He.asMonths=ve,He.asYears=we,He.valueOf=Gc,He._bubble=Cc,He.get=Ic,He.milliseconds=xe,He.seconds=ye,He.minutes=ze,He.hours=Ae,He.days=Be,He.weeks=Kc,He.months=Ce,He.years=De,He.humanize=Oc,He.toISOString=Pc,He.toString=Pc,He.toJSON=Pc,He.locale=qb,He.localeData=rb,
// Deprecations
He.toIsoString=ba("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)",Pc),He.lang=Vd,
// Side effect imports
// FORMATTING
J("X",0,0,"unix"),J("x",0,0,"valueOf"),
// PARSING
O("x",md),O("X",pd),R("X",function(a,b,c){c._d=new Date(1e3*parseFloat(a,10))}),R("x",function(a,b,c){c._d=new Date(r(a))}),
//! moment.js
//! version : 2.10.6
//! authors : Tim Wood, Iskren Chernev, Moment.js contributors
//! license : MIT
//! momentjs.com
a.version="2.10.6",b(Aa),a.fn=ge,a.min=Ca,a.max=Da,a.now=Pd,a.utc=h,a.unix=gc,a.months=sc,a.isDate=d,a.locale=x,a.invalid=l,a.duration=Va,a.isMoment=p,a.weekdays=uc,a.parseZone=hc,a.localeData=z,a.isDuration=Fa,a.monthsShort=tc,a.weekdaysMin=wc,a.defineLocale=y,a.weekdaysShort=vc,a.normalizeUnits=B,a.relativeTimeThreshold=Nc,a.prototype=ge;var Ie=a,Je=[/^янв/i,/^фев/i,/^мар/i,/^апр/i,/^ма[й|я]/i,/^июн/i,/^июл/i,/^авг/i,/^сен/i,/^окт/i,/^ноя/i,/^дек/i],Ke=(Ie.defineLocale("ru",{months:{format:"Января_Февраля_Марта_Апреля_Мая_Июня_Июля_Августа_Сентября_Октября_Ноября_Декабря".split("_"),standalone:"Январь_Февраль_Март_Апрель_Май_Июнь_Июль_Август_Сентябрь_Октябрь_Ноябрь_Декабрь".split("_")},monthsShort:{format:"янв_фев_мар_апр_мая_июня_июля_авг_сен_окт_ноя_дек".split("_"),standalone:"янв_фев_март_апр_май_июнь_июль_авг_сен_окт_ноя_дек".split("_")},weekdays:{standalone:"Воскресенье_Понедельник_Вторник_Среда_Четверг_Пятница_Суббота".split("_"),format:"Воскресенье_Понедельник_Вторник_Среду_Четверг_Пятницу_Субботу".split("_"),isFormat:/\[ ?[Вв] ?(?:прошлую|следующую|эту)? ?\] ?dddd/},weekdaysShort:"Вс_Пн_Вт_Ср_Чт_Пт_Сб".split("_"),weekdaysMin:"Вс_Пн_Вт_Ср_Чт_Пт_Сб".split("_"),monthsParse:Je,longMonthsParse:Je,shortMonthsParse:Je,longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD.MM.YYYY",LL:"D MMMM YYYY г.",LLL:"D MMMM YYYY г., HH:mm",LLLL:"dddd, D MMMM YYYY г., HH:mm"},calendar:{sameDay:"[Сегодня в] LT",nextDay:"[Завтра в] LT",lastDay:"[Вчера в] LT",nextWeek:function(a){if(a.week()===this.week())return 2===this.day()?"[Во] dddd [в] LT":"[В] dddd [в] LT";switch(this.day()){case 0:return"[В следующее] dddd [в] LT";case 1:case 2:case 4:return"[В следующий] dddd [в] LT";case 3:case 5:case 6:return"[В следующую] dddd [в] LT"}},lastWeek:function(a){if(a.week()===this.week())return 2===this.day()?"[Во] dddd [в] LT":"[В] dddd [в] LT";switch(this.day()){case 0:return"[В прошлое] dddd [в] LT";case 1:case 2:case 4:return"[В прошлый] dddd [в] LT";case 3:case 5:case 6:return"[В прошлую] dddd [в] LT"}},sameElse:"L"},relativeTime:{future:"через %s",past:"%s назад",s:"несколько секунд",m:Rc,mm:Rc,h:"час",hh:Rc,d:"день",dd:Rc,M:"месяц",MM:Rc,y:"год",yy:Rc},meridiemParse:/ночи|утра|дня|вечера/i,isPM:function(a){return/^(дня|вечера)$/.test(a)},meridiem:function(a,b,c){return 4>a?"ночи":12>a?"утра":17>a?"дня":"вечера"},ordinalParse:/\d{1,2}-(й|го|я)/,ordinal:function(a,b){switch(b){case"M":case"d":case"DDD":return a+"-й";case"D":return a+"-го";case"w":case"W":return a+"-я";default:return a}},week:{dow:1,// Monday is the first day of the week.
doy:7}}),Ie);return Ke.locale("en"),Ke});
...
angular.module("ScheduleModule",["ngMaterial","angularMoment","ngLodash"]).config(["$mdThemingProvider",function(e){e.theme("accept").dark().primaryPalette("green",{"default":"800"}).accentPalette("orange").accentPalette("pink"),e.theme("default").primaryPalette("grey",{"default":"800"}).accentPalette("red",{"default":"700"}).warnPalette("red",{"default":"800"})}]).run(["moment","amMoment","$rootScope",function(e,t,r){e.locale("ru"),t.changeLocale("ru"),r.scheduleTime=["00:00-01:00","01:00-02:00","02:00-03:00","03:00-04:00","04:00-05:00","05:00-06:00","06:00-07:00","07:00-08:00","08:00-09:00","09:00-10:00","10:00-11:00","11:00-12:00","12:00-13:00","13:00-14:00","14:00-15:00","15:00-16:00","16:00-17:00","17:00-18:00","18:00-19:00","19:00-20:00","20:00-21:00","21:00-22:00","22:00-23:00","23:00-00:00"],r.scheduleRepository=[]}]),angular.module("ScheduleModule").directive("scheduleHour",function(){return{templateUrl:"template/schedule.html"}}),angular.module("ScheduleModule").controller("DialogController",["$scope","$rootScope","$mdDialog","scheduleHourService","orientation","userIds","user","newScheduleHour","saveEnum","serverService","authorityEnum",function(e,t,r,n,a,o,u,l,d,s,c){var i,p,h,m=this,f=t.properties.workplaces,g=e.sch.tempAddedScheduleHours,S=e.sch.tempRemovedScheduleHours;s.getScheduleDataFromServerByCurrentWeek(e.sch.currentWeek).then(function(t){h=t.concat(e.sch.tempAddedScheduleHours),h=n.scheduleHoursWithoutTemp(h,e.sch.tempRemovedScheduleHours),m.prefs=n.checkScheduleForOpenMenu(l,h,g,a,o,f)}),m.isAdmin=u.authority===c.ADMIN,m.saveEnum=d,m.save=function(t,n){t===d.PLACE&&(l.place=n),t===d.PERSONID&&(l.peopleId=n),t===d.DISABLED&&(l.peopleId=0),m.isAdmin||(g.push(l),h.push(l),e.sch.scheduleHours=h),m.isAdmin&&s.addScheduleHour(l,h).then(function(t){e.sch.scheduleHours=t}),r.hide()},m.replace=function(t,n,a){m.isAdmin||(i=g.indexOf(t),p=-1!==i,p?g.splice(i,1):S.push(l),i=h.indexOf(t),h.splice(i,1),t=angular.copy(t),a===d.PLACE&&(t.place=n),a===d.PERSONID&&(t.peopleId=n),g.push(t),h.push(t),e.sch.scheduleHours=h),m.isAdmin&&s.replaceScheduleHour(t,h,a,n).then(function(t){e.sch.scheduleHours=t}),r.hide()},m.remove=function(t){m.isAdmin||(i=g.indexOf(t),p=-1!==i,p?g.splice(i,1):S.push(t),i=h.indexOf(t),h.splice(i,1),e.sch.scheduleHours=h),m.isAdmin&&s.removeScheduleHour(t,h).then(function(t){e.sch.scheduleHours=t}),r.hide()},m.extend=function(t){var n=moment.duration(5,"hours").afterMoment(moment(l.dateHourStart).minute(0).second(0)),a=moment.duration(t.hours,"hours").afterMoment(moment(t.dateHourStart).minute(0).second(0)),o=n.union(a),u={dateHourStart:o.start().format("YYYY-MM-DD HH:mm:ss"),hours:o.length("hours"),peopleId:t.peopleId,place:t.place};m.isAdmin||(i=g.indexOf(t),p=-1!==i,p?g.splice(i,1):S.push(t),i=h.indexOf(t),h.splice(i,1),g.push(u),h.push(u),e.sch.scheduleHours=h),m.isAdmin&&s.extendScheduleHour(t,u,h).then(function(t){e.sch.scheduleHours=t}),r.hide()},m.hide=function(){r.hide()}}]),angular.module("ScheduleModule").controller("ScheduleController",["$mdDialog","$scope","$rootScope","weekService","scheduleHourService","orientationEnum","userService","$q","$http","$location","$interval","$timeout","serverService","authorityEnum","tempTypeEnum",function(e,t,r,n,a,o,u,l,d,s,c,i,p,h,m){function f(){p.getUsersFromServer().then(function(e){v.users=e}),p.getScheduleDataFromServerByCurrentWeek(v.currentWeek).then(function(e){v.scheduleHours=e}),t.$watch("sch.hasAction",function(){i(function(){v.hasAction=!1},500)}),c(function(){v.hasAction&&p.getScheduleDataFromServerByCurrentWeek(v.currentWeek).then(function(e){v.tempErrors=a.containsInTemp(e,v.tempAddedScheduleHours),g=e.concat(v.tempAddedScheduleHours),g=a.scheduleHoursWithoutTemp(g,v.tempRemovedScheduleHours),v.scheduleHours=g})},1e3)}var g,S,v=this;v.tempAddedScheduleHours=[],v.tempRemovedScheduleHours=[],v.users={},v.scheduleHours=[],v.orientation=o.DAYBYNAME,v.orientationEnum=o,v.isPlanningDay=!1,v.hasAction=!1,v.tempErrors=[],S=s.search(),v.user=S.hasOwnProperty("user")?{authority:"USER",peopleId:S.user}:{authority:"ADMIN"},v.currentWeek=S.hasOwnProperty("day")?n.init(S.day):n.init(),v.isPlanningDay=n.isPlanningDay(r.properties.planingDays),c(function(){v.isPlanningDay=n.isPlanningDay(r.properties.planingDays)},3e4),v.isAdmin=v.user.authority===h.ADMIN,f(),v.setOrientation=function(e){v.orientation=e},v.nextWeek=function(){v.currentWeek=n.next(v.currentWeek),p.getScheduleDataFromServerByCurrentWeek(v.currentWeek).then(function(e){v.scheduleHours=e})},v.lastWeek=function(){v.currentWeek=n.previous(v.currentWeek),p.getScheduleDataFromServerByCurrentWeek(v.currentWeek).then(function(e){v.scheduleHours=e})},v.selectWorkplace=function(r,n,a,o,u){e.show({targetEvent:r,scope:t.$new(),clickOutsideToClose:!0,controller:"DialogController as dialog",templateUrl:"template/menu.html",hasBackdrop:!1,disableParentScroll:!1,locals:{newScheduleHour:n,orientation:a,userIds:o,user:u}})},v.selectOrientation=function(e,t){e(t)},v.sendToServerFromTemp=function(){0!==v.tempAddedScheduleHours.length&&p.sendTempToServer(v.tempAddedScheduleHours,m.ADDED).then(function(){v.tempAddedScheduleHours=[]}),0!==v.tempRemovedScheduleHours.length&&p.sendTempToServer(v.tempRemovedScheduleHours,m.REMOVED).then(function(){v.tempRemovedScheduleHours=[]})}}]),angular.module("ScheduleModule").factory("authorityEnum",function(){return{USER:"USER",ADMIN:"ADMIN"}}),angular.module("ScheduleModule").factory("command",function(){return{ADD:0,CLEAR:1}}),angular.module("ScheduleModule").factory("orientationEnum",function(){return{DAYBYNAME:0,NAMEBYDAY:1,PLACEBYDAY:2}}),angular.module("ScheduleModule").factory("saveEnum",function(){return{DISABLED:0,PLACE:1,PERSONID:2}}),angular.module("ScheduleModule").factory("tempTypeEnum",function(){return{ADDED:0,REMOVED:1}}),angular.module("ScheduleModule").factory("scheduleHourService",["moment","$http","orientationEnum",function(e,t,r){function n(t,r){var n=e.duration(r,"hours");return n.afterMoment(e(t).minute(0).second(0))}function a(e,t){var r=t.indexOf(e);-1!==r&&t.splice(r,1)}function o(e){var t,r,n=24,a=angular.copy(e);for(t=0;t<a.length;t++)for(a[t]=new Array(n),r=0;n>r;r++)a[t][r]=0;return a}function u(e,t){var r,n,a=-1;for(r=0,n=t.length;n>r;r++)if(l(t[r],e)){a=r;break}return a}function l(e,t){var r,n,a,o,u=!1;return"undefined"!=typeof e&&"undefined"!=typeof t&&(r=e.dateHourStart===t.dateHourStart,n=e.hours===t.hours,a=e.peopleId==t.peopleId,o=e.place===t.place,r&&n&&a&&o&&(u=!0)),u}return{equals:l,checkScheduleForOpenMenu:function(t,o,u,l,d,s){var c,i,p,h,m,f,g,S,v,A,D,Y,y,E,k,H,M,C,O,B,I,W,b,T;return A=n(e(t.dateHourStart).subtract(1,"hours"),t.hours+1+1),g=n(t.dateHourStart,t.hours),S=angular.copy(s),v=angular.copy(s),O=angular.copy(d),B=angular.copy(d),D=!1,Y=!1,y=!1,E=!1,I=!0,T=!1,k={},H=[],W=[],M=[],C=l===r.PLACEBYDAY,angular.forEach(o,function(e){c=n(e.dateHourStart,e.hours),i=g.overlaps(c),b=A.overlaps(c),p=e.peopleId==t.peopleId,f=e.place==t.place,E=0===e.place&&0===e.peopleId,h=g.equals(c)||g.engulfs(c)||c.engulfs(g),(p||f)&&b&&!h&&(Y=!0),(p||f||E)&&i&&H.push(e),(p||f||E)&&b&&W.push(e),i&&M.push(e),C||!i||p||0==e.place||a(e.place,S),C&&i&&!f&&0!=e.peopleId&&a(e.peopleId.toString(),O)}),H.length>=2&&angular.forEach(H,function(e){-1!==u.indexOf(e)&&(T=!0,H=[e])}),(H.length>=2||0===H.length&&(0===S.length||0===O.length))&&(y=!0),1!==H.length&&1!==W.length||(1===W.length&&(k=W[0]),1===H.length&&(k=H[0],D=!0),2===W.length&&(Y=!1,angular.forEach(W,function(e){0===e.place&&(Y=!0)})),angular.forEach(o,function(e){c=n(e.dateHourStart,e.hours),m=n(k.dateHourStart,k.hours),i=m.overlaps(c),!C&&i&&0!=e.place&&a(e.place,v),C&&i&&0!=e.peopleId&&a(e.peopleId.toString(),B)})),Y&&0!==k.place&&-1===S.indexOf(k.place)&&(Y=!1),(!C&&M.length>0||C&&H.length>0)&&(I=!1),1===H.length&&0===k.peopleId&&(v=[],B=[]),(1===H.length||1===W.length)&&0===k.place&&M.length>1&&(Y=!1),y&&(O=[],S=[]),{targetScheduleHour:k,workPlaces:S,workPlacesForReplacement:v,usersIds:O,usersIdsForReplacement:B,canBeDeletedOrReplaced:D,canBeExtended:Y,nothingCanDo:y,canBeBlocked:I,intersectWithTemp:T}},getTakenWorkplaces:function(t,r,n){var a,u,l,d,s,c,i,p=o(t),h=[],m=r.length;return angular.forEach(n,function(r){for(u=e(r.dateHourStart),l=u.hours(),d=u.format("YYYY-MM-DD"),s=t.indexOf(d),i=r.hours,c=0;i>c;c++)l+c===24&&(++s,i-=c,l=0,c=0),s>8||(a=p[s][l+c]+1,a===m&&h.push({day:t[s],hour:l+c}),p[s][l+c]=a)}),h},splitScheduleHours:function(e){var t=[],r=[];return angular.forEach(e,function(e){0===e.peopleId?t.push(e):r.push(e)}),{workedScheduleHours:r,blockedScheduleHours:t}},containsInTemp:function(e,t){var r,a,o,u,l,d,s,c,i=[];return angular.forEach(e,function(e){r=n(e.dateHourStart,e.hours),angular.forEach(t,function(t){a=n(t.dateHourStart,t.hours),u=r.overlaps(a),l=e.place===t.place,s=0===e.place,c=e.peopleId==t.peopleId,u&&(l||s||c)&&(o=r.intersection(a),d={dateHourStart:o.start().format("YYYY-MM-DD HH:mm:ss"),hours:o.length("hours")},i.push(d))})}),i},scheduleHoursWithoutTemp:function(e,t){var r;return angular.forEach(t,function(t){r=u(t,e),-1!==r&&e.splice(r,1)}),e}}}]),angular.module("ScheduleModule").factory("serverService",["$http","$q","weekService","userService","saveEnum","tempTypeEnum","$rootScope",function(e,t,r,n,a,o,u){var l={usersGET:"/api/users",scheduleGET:"/api/schedule",savePOST:"/api/schedule/save",removePOST:"/api/schedule/remove",saveTempPOST:"/api/schedule/save/all",removeTempPOST:"/api/schedule/remove/all"};return u.server&&(l=u.server),{getScheduleDataFromServerByCurrentWeek:function(n){var a=t.defer(),o=r.requestData(n);return e.get(l.scheduleGET,{params:o}).then(function(e){a.resolve(e.data)}),a.promise},getUsersFromServer:function(){var r,a=t.defer();return e.get(l.usersGET).then(function(e){r=n.transformUsersToUsersWithWorkHours(e.data),a.resolve(r)}),a.promise},addScheduleHour:function(r,n){var a=t.defer();return e.post(l.savePOST,r).then(function(){n.push(r),a.resolve(n)}),a.promise},removeScheduleHour:function(r,n){var a,o=t.defer();return e.post(l.removePOST,r).then(function(){a=n.indexOf(r),n.splice(a,1),o.resolve(n)}),o.promise},replaceScheduleHour:function(r,n,o,u){var d,s=t.defer();return e.post(l.removePOST,r).then(function(){d=n.indexOf(r),n.splice(d,1),o===a.PLACE&&(r.place=u),o===a.PERSONID&&(r.peopleId=u),e.post(l.savePOST,r).then(function(){r=angular.copy(r),n.push(r),s.resolve(n)})}),s.promise},extendScheduleHour:function(r,n,a){var o,u=t.defer();return e.post(l.removePOST,r).then(function(){o=a.indexOf(r),a.splice(o,1),e.post(l.savePOST,n).then(function(){a.push(n),u.resolve(a)})}),u.promise},sendTempToServer:function(t,r){var n;return r===o.ADDED&&(n=l.saveTempPOST),r===o.REMOVED&&(n=l.removeTempPOST),e.post(n,t)}}}]),angular.module("ScheduleModule").factory("userService",function(){return{transformUsersToUsersWithWorkHours:function(e){var t={};return angular.forEach(e,function(e,r){var n=e.split(" ");t[r]={name:n[0]+" "+n[1],hours:0}}),t},resetWorkHours:function(e){return angular.forEach(e,function(e){e.hours=0}),e},getArrayOfIds:function(e){return Object.keys(e)}}}),angular.module("ScheduleModule").factory("weekService",["moment",function(e){return{init:function(t){var r=!!t,n=(r?e(t,"YYYY-MM-DD"):e().add(1,"weeks")).startOf("week"),a=(r?e(t,"YYYY-MM-DD"):e().add(1,"weeks")).endOf("week"),o=n.twix(a),u=n.subtract(1,"days").twix(a.add(1,"days"));return{currentWeekNormal:o,currentWeekAdditional:u}},next:function(e){var t=e.currentWeekNormal.start().add(1,"weeks"),r=e.currentWeekNormal.end().add(1,"weeks"),n=t.twix(r),a=t.subtract(1,"days").twix(r.add(1,"days"));return{currentWeekNormal:n,currentWeekAdditional:a}},previous:function(e){var t=e.currentWeekNormal.start().subtract(1,"weeks"),r=e.currentWeekNormal.end().subtract(1,"weeks"),n=t.twix(r),a=t.subtract(1,"days").twix(r.add(1,"days"));return{currentWeekNormal:n,currentWeekAdditional:a}},requestData:function(e){var t=e.currentWeekAdditional.start().format("YYYY-MM-DD HH:mm:ss"),r=e.currentWeekAdditional.end().format("YYYY-MM-DD HH:mm:ss");return{from:t,to:r}},getArrayOfDates:function(e){for(var t=[],r=e.currentWeekAdditional.iterate("days");r.hasNext();)t.push(r.next().format("YYYY-MM-DD"));return t},isPlanningDay:function(t){var r,n=!0;return r=e().format("dddd"),angular.forEach(t,function(e){e===r&&(n=!0)}),n}}}]),angular.module("ScheduleModule").directive("schedule",["$rootScope","$document","moment","orientationEnum","weekService","scheduleHourService","userService","command","authorityEnum","lodash",function(e,t,r,n,a,o,u,l,d,s){function c(e,t){var n,a,o,u,l;for(n=r(e.dateHourStart),o=n.hours(),l=e.hours,a=0,u=0;l>u;u++)o+u===24&&(++a,l-=u,o=0,u=0),t(a,o+u,u)}function i(e,t,r,n,a){for(var o=angular.element("td[tb = "+e+"][tr = "+t+"][td = "+r+"]"),u=angular.element("th[th = "+r+"]"),l=angular.element("td[ttb = "+e+"][ttr = "+t+"]"),d=0;n>d;d++)o=a?o.addClass("green").next("td"):o.removeClass("green").next("td"),u=a?u.addClass("green-text").next("th"):u.removeClass("green-text").next("th");a?l.addClass("green-text").next("th"):l.removeClass("green-text").next("th")}function p(e,t,r,a){var o,u,l,d,s,c;o=parseInt(angular.element(e.target).attr("tb")),u=parseInt(angular.element(e.target).attr("tr")),l=parseInt(angular.element(e.target).attr("td")),24>=l+a?i(o,u,l,a,t,r):(d=24-l,s=a-d,c=0,i(o,u,l,d,t),r===n.DAYBYNAME?i(o,u+1,c,s,t,r):r!==n.NAMEBYDAY&&r!==n.PLACEBYDAY||i(o+1,u,c,s,t,r))}var h=this;h.nameByDay=[],h.dayByName=[],h.placeByDay=[],h.scrollLeftRotateTable=0;var m={createCleanSchedule:function(e,t,r,a){var o,l,d,s,c,i,p,h,m,f,g,S,v=t===n.DAYBYNAME,A=t===n.NAMEBYDAY,D=t===n.PLACEBYDAY,Y="ADMIN"===a.authority,y=[],E=["Вс","Пн","Вт","Ср","Чт","Пт","Сб","Вс","Пн"],k=24,H=u.getArrayOfIds(e),M=v?H:E;for(A&&(S=H),v&&(S=E),D&&(S=r),p=D?M.length-1:0;D?p>=0:p<M.length;D?p--:p++)if(h=0===p,m=p===M.length-1,!A&&!D||!h&&!m){for(o=angular.element("<tbody/>"),(A||D)&&(h=1===p),i=D?S.length-1:0;D?i>=0:i<S.length;D?i--:i++){for(f=0===i,g=i==S.length-1,l=angular.element("<tr/>"),((A||v)&&!(i%S.length)||D&&g)&&(v&&Y&&(s=angular.element('<span person-id="'+H[p]+'">'+e[H[p]].name+"</span>")),v&&!Y&&(s=angular.element('<span person-id="'+H[p]+'"/>')),(A||D)&&(s=angular.element("<span>"+E[p]+"</span>")),d=angular.element('<td rowspan="'+S.length+'"></td>'),(A||D)&&d.addClass("day-by-name"),v?d.addClass("person-name"):d.addClass("day-name"),d.append(s),v&&d.append(angular.element('<span with-hours class="layout-margin block"/>')),d.addClass("title md-headline"),D&&d.addClass("rotate"),l.append(d)),v&&(s=angular.element("<span>"+E[i]+"</span>")),A&&(s=angular.element("<span>"+e[H[i]].name+"</span>")),D&&(s=angular.element("<span>"+r[i]+"</span>")),d=angular.element("<td ttb="+p+" ttr="+i+"></td>"),(A||D)&&d.addClass("day-by-name"),v&&(f||g)&&s.addClass("anotherWeek"),(A||D)&&d.addClass("person-name"),v&&d.addClass("day-name"),d.append(s),d.addClass("title md-subhead"),D&&d.addClass("rotate"),l.append(d),c=0;k>c;c++)d=angular.element("<td/>"),d.attr("tb",p),d.attr("tr",i),d.attr("td",c),v&&(f||g)?d.addClass("anotherWeek"):d.addClass("active-td"),l.append(d);D&&(s=angular.element("<span>"+r[i]+"</span>"),d=angular.element("<td ttb="+p+" ttr="+i+"></td>"),d.addClass("day-by-name person-name title md-subhead rotate"),d.append(s),l.append(d)),D&&g&&(s=angular.element("<span>"+E[p]+"</span>"),d=angular.element('<td rowspan="'+S.length+'"></td>'),d.addClass("day-by-name day-name title md-headline rotate"),d.append(s),l.append(d)),o.append(l)}o.append(l),y.push(o)}return y},getCleanSchedule:function(e,t,r,a){var o,l,d,s,c,i,p=t===n.DAYBYNAME,f=t===n.NAMEBYDAY,g=t===n.PLACEBYDAY,S="USER"===a.authority;if(t===n.DAYBYNAME&&(l=angular.copy(h.dayByName)),t!==n.NAMEBYDAY||S||(l=angular.copy(h.nameByDay)),t!==n.PLACEBYDAY||S||(l=angular.copy(h.placeByDay)),S&&(o=u.getArrayOfIds(r).indexOf(a.peopleId.toString()),e.append(l[o])),!S)for(d=0;d<l.length;d++)s=0===d,c=d===l.length-1,i=l[d],(!s&&(f||p)||g)&&i.prepend(angular.element('<tr><td colspan="26" class="divider"></td></tr>')),e.append(i),(f&&!c||g&&!c)&&i.append(angular.element('<tr><td colspan="28" class="divider border"></td></tr>'));return m},removeSchedule:function(e){return angular.element("div[person-name]").remove(),angular.element(e.find("tbody")).remove(),m},addActionListeners:function(e,t,a,o,u,l,d){return angular.element(document).off("mouseenter mouseleave mouseover mouseout click","td.active-td").on({mouseover:function(){e.$parent.sch.hasAction=!0,h.scrollLeftRotateTable=angular.element("[table-container]").scrollLeft()},mouseenter:function(e){p(e,!0,t,a)},mouseleave:function(e){p(e,!1,t,a)},click:function(s){var c,i,p=0,m=void 0,f=parseInt(angular.element(s.target).attr("tb")),g=parseInt(angular.element(s.target).attr("tr")),S=parseInt(angular.element(s.target).attr("td"));t===n.PLACEBYDAY&&(h.scrollLeftRotateTable=angular.element("[table-container]").scrollLeft()),t===n.DAYBYNAME&&(m=o[f],c=u[g]),t===n.NAMEBYDAY&&(c=u[f],m=o[g]),t===n.PLACEBYDAY&&(c=u[f],p=l[g]),i={dateHourStart:r(c).hours(S).minute(0).second(0).format("YYYY-MM-DD HH:mm:ss"),hours:a,peopleId:m,place:p},e.$parent.sch.selectWorkplace(s,i,t,o,d)}},"td.active-td"),m},addDataToSchedule:function(e,t,a,o,l,d,s){var i,p,f,g,S,v,A,D,Y,y,E,k,H,M,C,O,B,I=t===n.DAYBYNAME,W=t===n.NAMEBYDAY,b=t===n.PLACEBYDAY,T=u.getArrayOfIds(o);return O=20,B=s?5:-133,b&&(angular.element("[table-container]").scrollLeft(150),angular.element("#table").removeClass("rotate place-by-day")),angular.forEach(e,function(e){i=r(e.dateHourStart),p=T.indexOf(e.peopleId.toString()),f=l.indexOf(i.format("YYYY-MM-DD")),g=d.indexOf(e.place),S=I?p:f,W&&(v=p),I&&(v=f),b&&(v=g),A=i.hours(),D=b?e.peopleId:e.place,(!W&&!b||0!==f&&8!==f)&&c(e,function(t,r,n){if(I&&(y="td[tb = "+S+"][tr = "+(v+t)+"][td = "+r+"]"),(W||b)&&(y="td[tb = "+(S+t)+"][tr = "+v+"][td = "+r+"]"),Y=angular.element(y),(I||W)&&Y.text(D),b&&(E=o[D.toString()],C=A+e.hours<24?e.hours:0===t?24-A:e.hours-(24-A),Y.addClass("person"+p)),b&&C>=3&&(0===r||0===n)){k=Y.position();var a=i.format("YYYY-MM-DD-HH");y="<div person-name place="+e.place+" hour= "+a+">"+E.name+"</div>",H=angular.element(y),H.css({top:k.top+O,left:k.left+B,height:34*C}),M=angular.element(document.getElementById("table")),M.append(H)}})}),b&&(angular.element("#table").addClass("rotate place-by-day"),angular.element("[table-container]").scrollLeft(h.scrollLeftRotateTable)),m},addWorkHoursToPersons:function(e,t,a,o){if(o===n.DAYBYNAME){var l,d,s,c,i=0,p=u.resetWorkHours(t),h=angular.element("span[person-id]"),f=angular.element(document.querySelectorAll("[with-hours]"));angular.forEach(e,function(e){0!=e.peopleId&&(d=r.duration(e.hours,"hours").afterMoment(e.dateHourStart),a.currentWeekNormal.overlaps(d)&&(c=d.intersection(a.currentWeekNormal).asDuration("days").asHours(),p[e.peopleId.toString()].hours+=Math.round(c)))}),angular.forEach(h,function(e){s=parseInt(angular.element(e).attr("person-id")),l=p[s].hours,angular.element(f[i]).text(l+" ч. "),i++})}return m},blockedWorkplaces:function(e,t,r,a){var o,u,d,s,c,i=r===n.DAYBYNAME,p=r===n.NAMEBYDAY;return angular.forEach(t,function(t){d=a.indexOf(t.day),s=t.hour,i&&(c="td[tr = "+d+"][td = "+s+"]"),p&&(c="td[tb = "+d+"][td = "+s+"]"),o=angular.element(c),angular.forEach(o,function(t){u=angular.element(t),e===l.ADD&&""===u.text()&&u.addClass("blocked"),e===l.CLEAR&&u.removeClass("blocked")})}),m},addBlockedByAdmin:function(e,t,a,o,u){var l,d,s,i,p,h,f=t===n.DAYBYNAME,g=t===n.NAMEBYDAY,S=t===n.PLACEBYDAY;return angular.forEach(e,function(e){i=r(e.dateHourStart),p=o.indexOf(i.format("YYYY-MM-DD")),h=u.indexOf(e.place),l=0===e.place,c(e,function(e,t){l&&f&&(s="td[tr = "+(p+e)+"][td = "+t+"]"),l&&(g||S)&&(s="td[tb = "+(p+e)+"][td = "+t+"]"),!l&&S&&(s="td[tb = "+(p+e)+"][tr = "+h+"][td = "+t+"]"),d=angular.element(s).addClass("block-admin")})}),m},checkTempWithServer:function(e,t,n,a){var o,d,s,i=u.getArrayOfIds(a),p=parseInt(angular.element("span[person-id]").attr("person-id")),h=i.indexOf(p.toString());return angular.forEach(t,function(t){o=n.indexOf(r(t.dateHourStart).format("YYYY-MM-DD")),c(t,function(t,r){d="td[tb = "+h+"][tr = "+(o+t)+"][td = "+r+"]",s=angular.element(d),e===l.ADD&&s.addClass("error"),e===l.CLEAR&&s.removeClass("error")})}),m},clearCurrentSchedule:function(e,t,a,o,u){var l,d,s,i,p,h,f,g,S,v,A,D,Y=t===n.DAYBYNAME,y=t===n.NAMEBYDAY,E=t===n.PLACEBYDAY,k=Object.keys(a);return angular.forEach(e,function(e){l=r(e.dateHourStart),A=0==e.peopleId,D=0===e.place&&0==e.peopleId,d=k.indexOf(e.peopleId.toString()),s=o.indexOf(l.format("YYYY-MM-DD")),i=u.indexOf(e.place),p=Y?d:s,Y&&(h=s),y&&(h=d),E&&(h=i),f=l.hours(),g=E?e.peopleId:e.place,angular.element("div[person-name][place="+e.place+"][hour="+l.format("YYYY-MM-DD-HH")+"]").remove(),c(e,function(e,t){Y&&!D&&(v="td[tb = "+p+"][tr = "+(h+e)+"][td = "+t+"]"),!y&&!E||D||(v="td[tb = "+(p+e)+"][tr = "+h+"][td = "+t+"]"),D&&Y&&(v="td[tr = "+(h+e)+"][td = "+t+"]"),D&&(y||E)&&(v="td[tb = "+(p+e)+"][td = "+t+"]"),S=angular.element(v),!Y&&!y||D||S.empty(),!E||D||A||S.removeClass("person"+d),(A||D)&&S.removeClass("block-admin")})}),m}};return{restrict:"A",scope:{scheduleHours:"=",blockedScheduleHours:"=",user:"=",users:"=",tempAddedScheduleHours:"=",orientation:"=",currentWeek:"=",tempErrors:"=",properties:"=",isPlanningDay:"="},controller:["$scope","$element",function(e,t){var r,c,i,p,f,g,S,v,A,D,Y,y,E,k,H,M,C,O,B,I,W,b,T,P,x,w=[],N=[];k=e.tempAddedScheduleHours,E=e.isPlanningDay,c=e.orientation,i=e.currentWeek,f=e.users,p=e.scheduleHours,c=e.orientation,y=e.user,C=e.tempErrors,r=e.properties,A=r.sessionLength,D=r.workplaces,e.$watch("tempErrors",function(e){O=C,C=e}),e.$watch("tempAddedScheduleHours",function(e){k=e}),e.$watch("currentWeek",function(e,t){i=e,H=t,S=a.getArrayOfDates(i),M=a.getArrayOfDates(H),T=!0}),e.$watch("users",function(a){f=a,void 0!==f&&0!==Object.keys(f).length&&(h.nameByDay=m.createCleanSchedule(f,n.NAMEBYDAY,r.workplaces,y),h.dayByName=m.createCleanSchedule(f,n.DAYBYNAME,r.workplaces,y),h.placeByDay=m.createCleanSchedule(f,n.PLACEBYDAY,r.workplaces,y),g=u.getArrayOfIds(f),e.$watch("orientation",function(r){c=r,v=!1,m.removeSchedule(t).getCleanSchedule(t,c,f,y).addActionListeners(e,c,A,g,S,D,y).addDataToSchedule(p,c,A,f,S,D,v).addWorkHoursToPersons(p,f,i,c).addBlockedByAdmin(N,c,A,S,D).blockedWorkplaces(l.ADD,w,c,S)}),e.$watchCollection("scheduleHours",function(t,r){v=!0,Y=o.splitScheduleHours(t),p=Y.workedScheduleHours,N=Y.blockedScheduleHours,P=S,B=s.differenceWith(t,r,o.equals),I=s.differenceWith(r,t,o.equals),Y=o.splitScheduleHours(B),W=Y.workedScheduleHours,b=Y.blockedScheduleHours,x=w,w=o.getTakenWorkplaces(P,D,t),T&&(W=p,b=N,I=r,P=M,T=!1),m.clearCurrentSchedule(I,c,f,P,D).blockedWorkplaces(l.CLEAR,x,c,P).addActionListeners(e,c,A,g,S,D,y).addDataToSchedule(W,c,A,f,S,D,v).addWorkHoursToPersons(t,f,i,c).addBlockedByAdmin(b,c,A,S,D).blockedWorkplaces(l.ADD,w,c,S),y.authority===d.USER&&m.checkTempWithServer(l.CLEAR,O,S,f).checkTempWithServer(l.ADD,C,S,f)}),e.$watch("isPlanningDay",function(t){E=t,(E||y.authority===d.ADMIN)&&m.addActionListeners(e,c,A,g,S,r.workplaces,y),E||y.authority!==d.USER||angular.element(document).off("mouseenter click","td.active-td")}))})}]}}]);
angular.module("ScheduleModule").run(["$templateCache", function($templateCache) {$templateCache.put("template/menu.html","<md-dialog aria-label=\"List dialog\"><md-dialog-content layout=\"column\" layout-align=\"space-around stretch\"><md-button ng-repeat=\"place in dialog.prefs.workPlaces\" class=\"md-primary\" ng-click=\"dialog.save(dialog.saveEnum.PLACE, place)\" ng-if=\"!dialog.prefs.canBeDeletedOrReplaced && !dialog.prefs.canBeExtended\r\n                   && !(sch.orientation === sch.orientationEnum.PLACEBYDAY)\"><md-icon class=\"material-icons\">work</md-icon><span class=\"layout-padding\">Рабочее место №{{place}}</span></md-button><md-button ng-repeat=\"place in dialog.prefs.workPlacesForReplacement\" class=\"md-primary\" ng-click=\"dialog.replace(dialog.prefs.targetScheduleHour, place, dialog.saveEnum.PLACE)\" ng-if=\"dialog.prefs.canBeDeletedOrReplaced && !dialog.prefs.canBeExtended && !dialog.prefs.intersectWithTemp\r\n                   && !(sch.orientation === sch.orientationEnum.PLACEBYDAY)\"><md-icon class=\"material-icons\">build</md-icon><span class=\"layout-padding\">Сменить на место №{{place}}</span></md-button><md-button ng-repeat=\"personId in dialog.prefs.usersIds\" class=\"md-primary\" ng-click=\"dialog.save(dialog.saveEnum.PERSONID, personId)\" ng-if=\"!dialog.prefs.canBeDeletedOrReplaced && !dialog.prefs.canBeExtended\r\n                   && (sch.orientation === sch.orientationEnum.PLACEBYDAY)\"><md-icon class=\"material-icons\">work</md-icon><span class=\"layout-padding\">{{sch.users[personId].name}}</span></md-button><md-button ng-repeat=\"personId in dialog.prefs.usersIdsForReplacement\" class=\"md-primary\" ng-click=\"dialog.replace(dialog.prefs.targetScheduleHour, personId, dialog.saveEnum.PERSONID)\" ng-if=\"dialog.prefs.canBeDeletedOrReplaced && !dialog.prefs.canBeExtended\r\n                   && (sch.orientation === sch.orientationEnum.PLACEBYDAY)\"><md-icon class=\"material-icons\">build</md-icon><span class=\"layout-padding\">Сменить на {{sch.users[personId].name}}</span></md-button><md-button ng-if=\"dialog.prefs.canBeExtended && !dialog.prefs.intersectWithTemp\r\n                   && (sch.isAdmin || !sch.isAdmin && dialog.prefs.targetScheduleHour.place !== 0)\" ng-click=\"dialog.extend(dialog.prefs.targetScheduleHour)\" class=\"md-primary\"><md-icon class=\"material-icons\">next_week</md-icon><span class=\"layout-padding\">Продлить сессию</span></md-button><md-button ng-if=\"dialog.prefs.canBeDeletedOrReplaced &&\r\n                   (sch.isAdmin || !sch.isAdmin && dialog.prefs.targetScheduleHour.place !== 0)\" ng-click=\"dialog.remove(dialog.prefs.targetScheduleHour)\" class=\"md-warn\"><md-icon class=\"material-icons\">delete</md-icon><span class=\"layout-padding\">Удалить сессию</span></md-button><md-button ng-if=\"dialog.prefs.nothingCanDo || !sch.isAdmin && dialog.prefs.targetScheduleHour.place === 0\" ng-click=\"dialog.hide()\" class=\"md-primary\"><md-icon class=\"material-icons\">error</md-icon><span class=\"layout-padding\">Нет доступных действий</span></md-button><md-button class=\"md-warn\" ng-click=\"dialog.save(dialog.saveEnum.DISABLED)\" ng-if=\"dialog.prefs.canBeBlocked && !dialog.prefs.canBeExtended && sch.isAdmin\"><md-icon class=\"material-icons\">block</md-icon><span class=\"layout-padding\">Заблокировать</span></md-button></md-dialog-content></md-dialog>");
$templateCache.put("template/schedule.html","<section ng-controller=\"ScheduleController as sch\" ng-cloak layout=\"column\" layout-align=\"center center\"><md-content class=\"layout-padding app fixed\" layout-align=\"center center\"><md-toolbar class=\"md-toolbar-tools\" layout=\"row\" layout-align=\"center center\"><md-button class=\"md-icon-button\" ng-click=\"sch.lastWeek()\" ng-if=\"sch.isAdmin\"><md-icon class=\"material-icons\">keyboard_arrow_left</md-icon></md-button><span flex></span><md-menu ng-if=\"sch.isAdmin\"><md-button class=\"md-icon-button\" ng-click=\"$mdOpenMenu($event)\"><md-icon class=\"material-icons\">menu</md-icon></md-button><md-menu-content width=\"3\"><md-menu-item ng-class=\"{active: sch.orientation === sch.orientationEnum.DAYBYNAME}\"><md-button ng-click=\"sch.setOrientation(sch.orientationEnum.DAYBYNAME)\">Дни по работникам</md-button></md-menu-item><md-menu-item ng-class=\"{active: sch.orientation === sch.orientationEnum.NAMEBYDAY}\"><md-button ng-click=\"sch.setOrientation(sch.orientationEnum.NAMEBYDAY)\">Работники по дням</md-button></md-menu-item><md-menu-item ng-class=\"{active: sch.orientation === sch.orientationEnum.PLACEBYDAY}\"><md-button ng-click=\"sch.setOrientation(sch.orientationEnum.PLACEBYDAY)\">Дни по местам</md-button></md-menu-item></md-menu-content></md-menu><span>{{sch.currentWeek.currentWeekNormal.simpleFormat(\'DD.MM.YYYY\')}}</span> <span flex></span><md-button class=\"md-icon-button\" ng-click=\"sch.nextWeek()\" ng-if=\"sch.isAdmin\"><md-icon class=\"material-icons\">keyboard_arrow_right</md-icon></md-button></md-toolbar><md-content layout=\"column\" layout-align=\"center center\" class=\"timeline\" ng-if=\"!(sch.orientation === sch.orientationEnum.PLACEBYDAY)\"><table class=\"head fixed-size\"><colgroup width=\"22%\" span=\"1\"></colgroup><colgroup width=\"3.25%\" span=\"24\"><thead><tr><th class=\"row-title actions\"><md-button class=\"md-raised md-primary\" md-theme=\"accept\" ng-click=\"sch.sendToServerFromTemp()\" ng-if=\"!sch.isAdmin\" ng-disabled=\"sch.users[sch.user.peopleId].hours < $root.properties.minWeekHours\r\n                                       || (sch.tempAddedScheduleHours.length === 0 && sch.tempRemovedScheduleHours.length === 0)\r\n                                       || sch.tempErrors.length !== 0\">Применить</md-button></th><th ng-repeat=\"time in scheduleTime\" th=\"{{$index}}\"><div class=\"vertical-text\">{{time}}</div></th></tr></thead></colgroup></table></md-content></md-content><md-content class=\"layout-padding app top\" layout=\"row\" ng-class=\"{thin: sch.orientation === sch.orientationEnum.PLACEBYDAY}\"><md-content class=\"timeline md-whiteframe-1dp\" ng-class=\"{rotate: sch.orientation === sch.orientationEnum.PLACEBYDAY}\" ng-if=\"sch.orientation === sch.orientationEnum.PLACEBYDAY\"><table class=\"head fixed-size rotate\"><colgroup width=\"10.7%\" span=\"1\"></colgroup><colgroup span=\"24\"></colgroup><colgroup width=\"10.7%\" span=\"1\"><thead><tr><th class=\"row-title actions double\"></th><th ng-repeat=\"time in scheduleTime\" th=\"{{$index}}\"><div class=\"vertical-text\">{{time}}</div></th><th class=\"row-title actions double\"></th></tr></thead></colgroup></table></md-content><md-content table-container class=\"md-whiteframe-1dp\" layout=\"row\" layout-align=\"start start\" flex><table schedule id=\"table\" class=\"fixed-size\" ng-class=\"{rotate: sch.orientation === sch.orientationEnum.PLACEBYDAY,\r\n                                  \'place-by-day\': sch.orientation === sch.orientationEnum.PLACEBYDAY}\" schedule-hours=\"sch.scheduleHours\" blocked-schedule-hours=\"sch.blockedScheduleHours\" users=\"sch.users\" user=\"sch.user\" temp-errors=\"sch.tempErrors\" temp-added-schedule-hours=\"sch.tempAddedScheduleHours\" is-planning-day=\"sch.isPlanningDay\" orientation=\"sch.orientation\" current-week=\"sch.currentWeek\" properties=\"$root.properties\"></table></md-content></md-content></section>");}]);